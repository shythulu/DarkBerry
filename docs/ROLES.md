...
| `ui.error` | `cranberry` | `#cc3838` | `#ff8a8a` | `#f06a6a` | `#f06a6a` | same |
| `ui.info` | `juniper` | `#1d7d6c` | `#bad9d4` | `#9ed0c4` | `#9ed0c4` | same |
| `ui.bell` | `honey` | `#90670a` | `#f0d6a0` | `#e8c98a` | `#e8c98a` | same |
| `ui.mark1` | `lavender` | `#7a58b0` | `#cebede` | `#baa8dc` | `#baa8dc` | same |
| `ui.mark2` | `plum` | `#9a4cc0` | `#ecbcfc` | `#ddb0ec` | `#ddb0ec` | same |
| `ui.mark3` | `bilberry` | `#2a6fb0` | `#9cc6ea` | `#7fb4e0` | `#7fb4e0` | same |
...
| `terminal.color17` | `blossom` | `#a15873` | `#eedce5` | `#e7c5d8` | `#e7c5d8` | same |
| `syntax.text` | `text` | `#4f3143` | `#f2e6ee` | `#efe3eb` | `#ede1e9` | same |
| `syntax.keyword` | `berry` | `#d21570` | `#fa99b4` | `#fd7ca5` | `#fd7ca5` | mauve |
| `syntax.function` | `petal` | `#b7437d` | `#ffc4dd` | `#feafd4` | `#feafd4` | blue |
| `syntax.type` | `plum` | `#9a4cc0` | `#ecbcfc` | `#ddb0ec` | `#ddb0ec` | yellow |
| `syntax.namespace` | `lavender` | `#7a58b0` | `#cebede` | `#baa8dc` | `#baa8dc` | yellow (as types) |
| `syntax.constant` | `blueberry` | `#3b5fd0` | `#a4c3f6` | `#8fb0f2` | `#8fb0f2` | peach |
| `syntax.number` | `honey` | `#90670a` | `#f0d6a0` | `#e8c98a` | `#e8c98a` | peach |
| `syntax.string` | `gooseberry` | `#377a37` | `#b7e6b7` | `#a3daa3` | `#a3daa3` | same |
| `syntax.regex` | `juniper` | `#1d7d6c` | `#bad9d4` | `#9ed0c4` | `#9ed0c4` | pink |
| `syntax.variable` | `blossom` | `#a15873` | `#eedce5` | `#e7c5d8` | `#e7c5d8` | text (maroon for parameters) |
| `syntax.property` | `mix(lavender,subtext0,0.5)` | `#725388` | `#cdbcd2` | `#c3b2d1` | `#c0b0ce` | blue |
| `syntax.operator` | `mix(overlay2,subtext0,0.4)` | `#775d6d` | `#c3aab9` | `#b9a0b0` | `#b29aa9` | sky |
| `syntax.punctuation` | `mix(overlay1,overlay2,0.35)` | `#8e7584` | `#ab8ca0` | `#9b8693` | `#927d8a` | overlay2 |
| `syntax.comment` | `overlay2` | `#806776` | `#bd9fb1` | `#ad8da2` | `#a58799` | same |
| `syntax.link` | `ui.link` | `#1b778c` | `#a0d0da` | `#86c0cc` | `#86c0cc` | blue |
| `syntax.error` | `ui.error` | `#cc3838` | `#ff8a8a` | `#f06a6a` | `#f06a6a` | same |
| `syntax.deprecated` | `mix(overlay1,overlay2,0.6)` | `#89707f` | `#b293a7` | `#a28999` | `#998190` | no equivalent |
| `syntax.unimplemented` | `mix(overlay1,lavender,0.2)` | `#907693` | `#ab8ea5` | `#998a9b` | `#928294` | no equivalent |
| `syntax.diff.removed` | `mix(cranberry,cherry,0.5)` | `#bf414b` | `#f39aa0` | `#e27e83` | `#e27e83` | red |
